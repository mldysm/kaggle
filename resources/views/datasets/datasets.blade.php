  ...
  <div class="py-4 px-4 mt-20 mx-auto max-w-screen-xl lg:py-8 lg:px-0">
    ...
    <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
      ...
      <div class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
        <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">Dataset {{ $i }}</h2>
        <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. 
        </p>
        <a href="/datasets/dataset" class="inline-flex items-center font-medium text-primary-600 dark:text-primary-500 hover:underline text-sm">
          View Dataset

  ...
  <div class="px-4 mx-auto mt-5 max-w-4xl">
    <div class="relative bg-white dark:bg-gray-800 shadow-md rounded-xl p-8">
      ...
      <div class="absolute top-4 right-4 flex space-x-2">
        <!-- Edit Button -->
        <a href="/datasets/dataset/edit" class="p-2 bg-yellow-500 hover:bg-yellow-600 text-white rounded-full focus:outline-none focus:ring-2 focus:ring-yellow-400" title="Edit">
      ...
      <a href="/datasets" class="text-blue-600 text-sm hover:underline block mb-4">&laquo; Back to Blog</a>
